    ...
    public static void main(String[] args) {
        //Atribuindo nome para meu scanner
            ...
            if(first.equalsIgnoreCase("Play")){
                System.out.println("Enzo escolhe a opçaõ de dar Play... Lá ele encontra um só uma porta que ao ser aberta o leva para um labirinto."+
                                    "Então, ele decide abrir a porta e dá de cara com dois caminhos distintos."+
                                    "Enzo percebe que está com uma barra de energia de 100% e não sabe o que vai acontecer com ela."+
                ...
                if(firstTwo.equalsIgnoreCase("Direita")){
                    ...
                    if(firstThree.equalsIgnoreCase("Subir")){
                        ...
                        System.out.println("Enzo escolhe descer, e ao descer toda a escadaria percebe que chegou ao centro da terra,"+
                                            ...
                                            "Ele se contenta com o conviveu com o jogo, mas decide não jogar e então ele sai do jogo e para sua cama chorar pois queria ter continuado o jogo...");
                    }
                }
