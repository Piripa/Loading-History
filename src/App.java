...
public class App {
    public static void main(String[] args) {
           ...
           // Personagem perso2 = new Personagem("Zara",50);  
            Capitulos cap1 = new Capitulos("Piloto","O ano era 2094... era aniversário de Enzo, que acabara de chegar da escola,"+
            ...
            Capitulos cap5 = new Capitulos("Pequena vitória", "Enzo escolhe a porta da direita que ao abrir-lá encontra uma reta com uma luz no fim... "+
                                             ...
                                             "e então Zara o pergunta, você vai subir ou vai descer?\nDigite se Enzo irá subir ou Descer", "Subir", "Descer", perso, 25,input);
                                             cap5.mostrar();
                                             int firstThree = cap5.escolher();
                     if(firstThree==1){
            Capitulos cap6 = new Capitulos("Chegada ao topo", "Enzo escolhe subir, e ao subir toda a escadaria percebe que chegou á cima das nuvens...", null ,null, perso, 25,input);
                                                cap6.mostrar();
                                               } 
               
                     else if(firstThree == 2){
            Capitulos cap7 = new Capitulos("Inferno à diante", "Enzo escolhe descer, e ao descer toda a escadaria percebe que chegou ao centro da terra,"+
                                                 "o qual é supreendido por larva e perde quase toda a sua energia"+
                                                 "mal sabe ele que Zara continua viva, pois próxima da larva ela ganha energia", null, null, perso, -100,input);
                                                  cap7.mostrar();
                                                }    
              }
                 else if(firstTwo == 2){
            Capitulos cap4 = new Capitulos("A primeira escolha errada", "Enzo escolhe a porta da esquerda, que o faz cair em um buraco bem profundo..."+
                                                ...
                                                "joga-o pela janela e vai dormir não querendo relembrar o que viveu no game.", null, null, perso, -75,input);          
                                                cap4.mostrar();
                                            }
         }
            else if(first == 2){
            Capitulos cap2 = new Capitulos("A decepção", "Enzo selecionou a opção Exit e com isso conseguiu sair do jogo, consequentemente,"+ 
                                            ...
                                            "Em sua cabeça só havia pensamentos de como teria acontecido isso, mas é algo que nunca saberás...", null, null, perso, -50,input);
                                            cap2.mostrar();
                                        }
                 input.close();  
        }             
